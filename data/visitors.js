...
window.GAME_VISITORS = [
  // 人类 · 4
  {name:"钟婆婆",category:"human",chapter:1,kind:"人类 · 钟表匠",icon:"👵",trait:"口袋里有许多细小的滴答声",item:"倒着走的怀表",story:"孙女第一次叫我奶奶的时候，我正忙着修钟，没来得及答应。只要一分钟，我想回去好好听一次。",pay:{type:"item",amount:4,item:"铜齿轮"},schedule:[{favor:0,weekday:[1],label:"每周一"},{favor:5,season:["winter"],label:"好感 5：冬季也会来"}]},
  {name:"裁缝小满",category:"human",chapter:1,kind:"人类 · 夜衣裁缝",icon:"🧑‍🎨",trait:"袖口别着一根红色骨针",item:"无声剪刀",story:"我要替一个害怕雷声的孩子做一件睡衣。普通剪刀会把惊雷剪进布里，我需要一把不会发出声音的剪刀。",pay:{type:"coins",amount:9,item:null},schedule:[{favor:0,weekday:[4],label:"每周四"},{favor:4,season:["summer"],label:"好感 4：夏季也会来"}]},
  ...
  // 兽客 · 4
  {name:"栗尾先生",category:"beast",chapter:1,kind:"兽客 · 狐狸",icon:"🦊",trait:"说话时总要先摸摸帽檐",item:"捕风瓶",story:"我替森林里的鸟儿保管歌声。昨晚有一支歌从盒中逃了出去，藏进了北风里。没有那支歌，知更鸟就等不到春天。",pay:{type:"coins",amount:7,item:null},schedule:[{favor:0,weekday:[3],label:"每周三"},{favor:4,season:["summer"],label:"好感 4：夏季也会来"}]},
  {name:"阿墨",category:"beast",chapter:1,kind:"兽客 · 乌鸦",icon:"🐦‍⬛",trait:"右眼戴着一枚黄铜单片镜",item:"不撒谎的镜子",story:"我的收藏里有三百七十二件闪亮的东西，却没有一件肯告诉我，我到底是不是一只好鸟。",pay:{type:"item",amount:3,item:"夜鸦羽毛"},schedule:[{favor:0,moon:["full"],label:"满月之夜"},{favor:0,weekday:[6],label:"每周六"},{favor:5,season:["autumn"],label:"好感 5：秋季也会来"}]},
  ...
  // 夜行异客 · 4
  {name:"雨巷邮差",category:"night",chapter:1,kind:"夜行人 · 邮差",icon:"🧥",trait:"衣角一直滴着并不存在的雨",item:"雨天火柴",story:"有一封信在我的包里睡了二十年。收信人住在一条只会在雨夜出现的街上，我需要一点火光认路。",pay:{type:"coins",amount:10,item:null},schedule:[{favor:0,weather:["rain"],label:"雨天"},{favor:0,weekday:[2],label:"每周二"},{favor:4,season:["spring"],label:"好感 4：春季也会来"}]},
  {name:"没有影子的小姐",category:"night",chapter:1,kind:"夜行人 · 身份不明",icon:"🎭",trait:"站在灯下，脚边仍空空如也",item:"影子雨伞",story:"我的影子离家出走了。它说除非我学会一个人散步，否则永远不回来。可街上的目光太亮了。",pay:{type:"item",amount:3,item:"月光碎片"},schedule:[{favor:0,moon:["new"],label:"新月之夜"},{favor:0,weekday:[5,7],label:"每周五、周日"},{favor:6,season:["winter"],label:"好感 6：冬季也会来"}]},
